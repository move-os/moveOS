...
#define FORMAT_STR_TO_MESSAGE_VARIABLE()                     char message[LOGGER_MESSAGE_STRING_BUFFER_SIZE];                                                                       \
                                                             ...
                                                             unsigned int __temp_uint__;                                                                                            \
                                                                                                                                                                                    \
                                                             for (unsigned int __format_str_index__ = 0; __format_str_index__ < strlen(format_str); __format_str_index__++) {       \
                                                                                                                                                                                    \
                                                               ...
                                                               __identifier_modifier__ = -1;                                                                                        \
                                                             	 ...
                                                             	 if ((__identifier_char__ == '0' ||                                                                                   \
                                                             		    ...
                                                             		    __identifier_char__ == '4') && (__format_str_index__ + 1 < strlen(format_str))) {                               \
                                                                                                                                                                                    \
